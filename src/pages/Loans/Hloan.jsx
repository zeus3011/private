...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 pt-8 px-8 bs-gray-100 mx-auto">
  ...
  <div className='hover:shadow-xl m-2 p-4 rounded-xl'>
    <img src={database} alt="" className='w-16'/>
  ...
  <div className='hover:shadow-xl m-2 p-4 rounded-xl'>
    <img src={track} alt="" className='w-16' />
  ...
  <div className='hover:shadow-xl m-2 p-4 rounded-xl' > 
    <img src={simple} alt="" className='w-16'/>
                      ...
                      {/* q1 */}
                        <div class="bg-white shadow rounded p-8">
                            <div class="flex items-center justify-between">
                                <div>
                                    <h2 class="text-base font-semibold leading-none text-gray-800">Do I qualify for a home loan to cover the home's value?</h2>
                                </div>
...
Based on the caps set in the RBI on LTV ratios, banks/HFCs also determine the LTV ratio according to the credit profile and risk assessment of the loanee. Creditworthy applicants with lower credit scores tend to be offered a lower LTV ratio.
                      ...
                      {/* q2 */}
                        <div class="bg-white shadow rounded p-8 mt-8">
                            <div class="flex items-center justify-between">
                                <div>
                                    <h2 class="text-base font-semibold leading-none text-gray-800">How can lenders determine the EMI creditworthiness of their mortgage applicants?</h2>
                                </div>
                                <button
                                    onClick={() => {
                                        setBox2(!box2);
                            ...
                            {box2 && (
                                <ul>
                                    <li>
                                        <p class="text-base leading-normal text-gray-600 mt-4 lg:w-96">Lenders consider the ability to repay homeowners when assessing their loan application and amount admissibility. House loan lenders generally prefer to lend to home loan applicants with the total EMIs, which includes the EMI of the home loan, which is less than 50-60 per cent of their monthly income. Therefore, home loan applicants can use the online mortgage EMI calculator to determine the best amount of a house loan and length, depending on their capacity to repay.</p>
                                    </li>
                                </ul>
                            )}
                        </div>
                      ...
                      {/* q3 */}
                        <div class="bg-white shadow rounded p-8 mt-8">
                            <div class="flex items-center justify-between">
                                <div>
                                    <h2 class="text-base font-semibold leading-none text-gray-800">What credit score do I need to be eligible for a mortgage for my home?</h2>
                                </div>
                                <button
                                    onClick={() => {
                                        setBox3(!box3);
                      ...
                      {/* q4 */}
                        <div class="bg-white shadow rounded p-8 mt-8">
                            <div class="flex items-center justify-between">
                                <div>
                                    <h2 class="text-base font-semibold leading-none text-gray-800">Who can co-sign on a home loan?</h2>
                                </div>
                            ...
                            {box4 && (
                                <ul>
                                    <li>
                                        <p class="text-base leading-normal text-gray-600 mt-4 lg:w-96">The spouse of your blood relatives, like your mother, father and siblings, can co-sign on a home loan with you. In addition, all co-owners of the property are required to be co-applicants on mortgages for housing.</p>
                                    </li>
                                </ul>
                            )}
                        </div>
                      ...
                      {/* q5 */}
                        <div class="bg-white shadow rounded p-8 mt-8">
                            <div class="flex items-center justify-between">
                                <div>
                                    <h2 class="text-base font-semibold leading-none text-gray-800">Are there any charges for prepayments for a home loan?</h2>
                                </div>
                            ...
                            {box5 && (
                                <ul>
                                    <li>
                                        <p class="text-base leading-normal text-gray-600 mt-4 lg:w-96">. In the case of home loans with floating rates, lenders do not apply a prepayment penalty by RBI guidelines. However, lenders can impose a penalty for early payment in the case of prepayment for mortgages with fixed rates.</p>
                                    </li>
                                </ul>
                            )}
                        </div>
                      ...
                      {/* q6 */}
                        <div class="bg-white shadow rounded p-8 mt-8">
                            <div class="flex items-center justify-between">
                                <div>
                                    <h2 class="text-base font-semibold leading-none text-gray-800">Can I get two loans for my home simultaneously?</h2>
                                </div>
                            ...
                            {box6 && (
                                <ul>
                                    <li>
                                        <p class="text-base leading-normal text-gray-600 mt-4 lg:w-96">Yes, suppose the creditor of the second loan to you has confidence in your capacity to pay, your credit profile, and the specifics of the pledged property and the property you are pledging. In that case, you may be eligible for another loan to buy another property.</p>
                                    </li>
                                </ul>
                            )}
                        </div>

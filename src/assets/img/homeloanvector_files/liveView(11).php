...
var SekindoClientDetections_URL = function (config) {
	...
	if (this.isPlayerApiActions && !this.isAmpProject && !this.isAmpIframe && !this.isApp) this.playerApiActions();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=108062&schain=1.0,1!pubgalaxy.com,12973,1&cbuster=623273426&cbuster=1662450359',
					origQString: 's=108062&schain=1.0,1!pubgalaxy.com,12973,1&cbuster=623273426',
					placementId: 108062,
					x: 300,
					y: 250,
					videoType: 'normal',
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"Windows","osVersion":"10.0","osVersionMajor":"10","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Chrome","browserType":"browser","browserVersion":"104.0.0.0","browserVersionMajor":"104","browserVersionMinor":"0","chromeVersion":"104"},"browser":"chrome","os":"windows","osVer":"","deviceType":"desktop","languages":{"0":"en","3":"hi"},"googlePSI":false},
					isFpCookie: 0,
					geo: 'IN',
					dmaCode: 0,
					dynamicSetup: [],
